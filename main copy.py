...
class MusecoreWebsite():
    ...
    def getScoreSheets(self, scoreUrl:str) -> list:
        ...
        body = self.driver.find_element(by=By.XPATH, value="//body")
        ...
        for iLetter, letter in enumerate(html):
            if letter == ">":
                if "class=\"KfFlO\"" in tagBuffer.split(" "): 
                    ...
                    elements = self.driver.find_elements(by=By.XPATH, value="//*[@id=\"jmuse-scroller-component\"]/div[{nextPage}]/img")
